...
impl ContractContext<OnChainContractStorage> for LiquidityGaugeRewardWrapper {
    fn storage(&self) -> &OnChainContractStorage {
        &self.0
    }
}
impl CURVEERC20<OnChainContractStorage> for LiquidityGaugeRewardWrapper {}
impl LIQUIDITYGAUGEREWARDWRAPPER<OnChainContractStorage> for LiquidityGaugeRewardWrapper {}
impl LiquidityGaugeRewardWrapper {
    fn constructor(
        &mut self,
        name: String,
        symbol: String,
        ...
        LIQUIDITYGAUGEREWARDWRAPPER::init(
            self,
            name,
            symbol,
            gauge,
...
fn constructor() {
    ...
    LiquidityGaugeRewardWrapper::default().constructor(
        name,
        symbol,
        gauge,
        admin,
...
fn set_approve_deposit() {
    ...
    LiquidityGaugeRewardWrapper::default().set_approve_deposit(addr, can_deposit);
}
...
fn withdraw() {
    let value: U256 = runtime::get_named_arg("value");
    LiquidityGaugeRewardWrapper::default().withdraw(value);
}
#[no_mangle]
fn allowance() {
...
fn transfer() {
    ...
    LIQUIDITYGAUGEREWARDWRAPPER::transfer(
...
fn transfer_from() {
    ...
    let recipient: Address = runtime::get_named_arg("recipient");
    let amount: U256 = runtime::get_named_arg("amount");
    LIQUIDITYGAUGEREWARDWRAPPER::transfer_from(
        &mut LiquidityGaugeRewardWrapper::default(),
        owner,
        recipient,
        amount,
...
#[no_mangle]
fn kill_me() {
    LiquidityGaugeRewardWrapper::default().kill_me();
}

#[no_mangle]
fn commit_transfer_ownership() {
    let addr: Key = runtime::get_named_arg("addr");
    LiquidityGaugeRewardWrapper::default().commit_transfer_ownership(addr);
}
